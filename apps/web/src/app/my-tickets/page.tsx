    ...
    <div className="space-y-8">
      ...
      {loading ? (
        <div className="py-20 text-center space-y-3">
          ...
          <p className="text-xs text-slate-500 font-semibold">Loading your ticket history...</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredTickets.map((ticket) => {
            ...
            return (
              <div
                key={ticket.id}
                className={`bg-white rounded-2xl border transition-all duration-300 p-5 shadow-xs flex flex-col justify-between space-y-4 relative overflow-hidden ${
                  isWinner
                    ? "border-purple-400 bg-purple-50/40 ring-2 ring-purple-500/50"
                    : "border-slate-200 hover:shadow-md"
                }`}
              >
                {/* Winner Ribbon */}
                {isWinner && (
                  <div className="absolute top-0 right-0 bg-purple-600 text-white text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-bl-xl flex items-center gap-1 shadow-sm">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="flex items-center gap-2 pt-0.5">
                      ...
                      {ticket.soldByAgent && (
                        <span className="text-[10px] font-medium text-emerald-700 truncate max-w-[120px]">
                ...
                <div className="flex items-center justify-between pt-1 text-xs">
                  <button
                    ...
                    className="text-emerald-700 hover:text-emerald-800 font-bold flex items-center gap-1.5 transition"
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white rounded-3xl max-w-sm w-full p-6 shadow-2xl border border-slate-200 space-y-6 relative text-center">
            ...
            <div className="space-y-1">
              <div className="w-10 h-10 bg-emerald-100 text-emerald-700 rounded-2xl flex items-center justify-center mx-auto mb-2">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-4 text-left">
              ...
              <div className="flex justify-between border-t border-slate-200 pt-2">
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs font-mono font-bold text-slate-800 bg-white px-2 py-1 rounded border border-slate-200 inline-block">
              ...
              <div className="flex justify-between border-t border-slate-200 pt-2 text-[11px]">
                <span className="text-slate-500">Method: {selectedReceipt.purchaseMethod}</span>
                <span className="text-slate-500">Status: CONFIRMED</span>
              </div>
            </div>

            {/* Mock QR Representation */}
            <div className="p-4 bg-slate-900 text-white rounded-2xl flex flex-col items-center justify-center space-y-1.5">
