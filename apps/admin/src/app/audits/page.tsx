            ...
            <tbody className="divide-y divide-slate-800">
              {loading ? (
                ...
                data?.drawAudits?.map((da: any) => (
                  <tr key={da.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="py-3.5 px-4 font-mono text-[10px] text-emerald-400 max-w-[140px] truncate" title={da.secretSeed}>
                      {da.secretSeed}
                    </td>
            ...
            <tbody className="divide-y divide-slate-800">
              {data?.accessLogs?.map((log: any) => (
                <tr key={log.id} className="hover:bg-slate-800/40 transition">
                  ...
                  <td className="py-3.5 px-4 font-mono text-slate-400 text-[11px] max-w-sm truncate">
                    {log.details}
                  </td>
